...
- **Lift over baseline**: 1.58x improvement over all-1s prediction
...
- **Optimal threshold range**: 0.18-0.28 (current: 0.6058)
- **Realistic optimal F1**: 0.71-0.74 (typical winning range for this competition type)
- **Gap to optimal**: 0.12477 F1 points
...
|-------|----------|--------|
| Current | 0.59523 | Baseline with current pipeline |
...
- Features: 48 selected from 90 engineered
- Algorithm: XGBoost with 676 trees
- Threshold: 0.6058 (optimized per fold)
