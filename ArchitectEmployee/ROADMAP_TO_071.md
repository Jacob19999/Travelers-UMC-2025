...
- **Optimal threshold range**: 0.18-0.28 (current: 0.5921)
- **Realistic optimal F1**: 0.71-0.74 (typical winning range for this competition type)
- **Gap to optimal**: 0.12260 F1 points
...
|-------|----------|--------|
| Current | 0.59740 | Baseline with current pipeline |
...
- Threshold: 0.5921 (optimized per fold)
